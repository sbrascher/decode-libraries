...
/// <summary>
/// Provides extension methods for adding FluentValidation <see cref="ValidationResult"/> errors to a <see cref="IDomainNotificationContext"/>.
/// </summary>
public static class NotificationContextExtensions
{
    /// <summary>
    /// Adds all errors from the specified <see cref="ValidationResult"/> to the <see cref="IDomainNotificationContext"/>.
    /// </summary>
    ...
    public static void AddValidationResult(
        this IDomainNotificationContext context,
